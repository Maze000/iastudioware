          ...
          <div className="bg-transparent rounded-2xl p-6 border border-border space-y-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Marketing & Support Retainer</p>
              </div>
            </div>
          ...
          <div className="bg-transparent rounded-2xl p-6 border border-border space-y-4">
            ...
            <div className="bg-muted/20 rounded-xl p-4">
              ...
              <div className="flex justify-center">
                ...
                <form
                  action="https://www.paypal.com/ncp/payment/RGKWARTD9FSTU"
                  method="post"
                  target="_blank"
                  style={{
                    display: 'inline-grid',
                ...
                >
                  <input className="pp-RGKWARTD9FSTU" type="submit" value="Buy Now" />
                  <img
...
export default MonthlyPlanPayment;
