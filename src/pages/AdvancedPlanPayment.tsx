        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-transparent rounded-2xl p-6 border border-border space-y-4">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Advanced Plan</h2>
                <p className="text-muted-foreground text-sm">eCommerce + Apps + AI</p>
              </div>
            </div>
          ...
          <div className="bg-transparent rounded-2xl p-6 border border-border space-y-4">
            ...
            <div className="bg-muted/20 rounded-xl p-4">
              ...
              <div className="flex justify-center">
                ...
                <form
                  action="https://www.paypal.com/ncp/payment/3BXCD56MV5HGJ"
                  method="post"
                  target="_blank"
                  style={{
                    display: 'inline-grid',
                ...
                >
                  <input className="pp-3BXCD56MV5HGJ" type="submit" value="Buy Now" />
                  <img
...
export default AdvancedPlanPayment;
