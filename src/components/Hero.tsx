...
import backHero from '@/assets/backHero.mp4';
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center bg-gradient-dark overflow-hidden pt-[50px] pb-[50px] md:pt-0 md:pb-0">
      
      {/* Background Effects */}
      <div className="absolute inset-0 bg-dark-accent z-0">
...
<div className="absolute inset-0 bg-black/60 z-0" />
  ...
  Smart websites/apps + modular automation = scalable growth.<br />
  <span className="text-white font-semibold">
    Level up your idea, personal brand, or business with smart apps.
  </span>
</p>
